...
<!-- <form name="memberFrm" action="/JSPServletBegin/chap03_StandardAction/06useBeanRegister.jsp" method="get"> /WebContent는 생략해야 함. -->
<form name="memberFrm" action="<%= ctxPath %>/chap03_StandardAction/06useBeanRegister.jsp" method="get"> <!-- /WebContent는 생략해야 함. -->
	<fieldset>
...
<script type="text/javascript" src="<%= ctxPath%>/js/jquery-3.3.1.min.js"></script><!-- /WebContent는 뺴야한다. -->
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("form[name=memberFrm]").submit(function() {
			...
			if (nameLength == 0) {
				alert("성명을 입력하세요!!");
				return false; // submit을 하지 않고 종료한다. 
			}
