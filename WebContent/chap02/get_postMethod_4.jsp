...
<form name="memberFrm" action="<%= request.getContextPath()%>/getpostMethod_4.do" method="get"> 
  또는
--%>
<form name="memberFrm" action="<%= ctxPath%>/getpostMethod_4.do" method="get">
<%-- 
     submit 을 하면 <%= ctxPath%>/getpostMethod_4.do 로 보내어서 처리를 요청한다.
         이번에는 /JSPServletBegin/getpostMethod_4.do 을 처리해주는 매핑작업을 배치서술자인 web.xml 을 사용하지 않고 
