...
<head>
<meta charset="UTF-8">
<title>1부터 10까지의 합을 자바에서 구한다음 그 결과를 HTML로 보여줄 것이다.</title>
...
<%
	...
	// 스크립틀릿(scriptlet)는 자바코드가 들어오는 부분이다.
...
%>
   ...
   <%-- JSP 주석문 --%>
    ...
    <%--
      ...
      C:\NCS\workspace(jsp)\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JSPServletBegin\org\apache\jsp\chap01\_01oneToTenSum_jsp.java와
      C:\NCS\workspace(jsp)\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JSPServletBegin\org\apache\jsp\chap01\_01oneToTenSum_jsp.class로 
             저장된다.
