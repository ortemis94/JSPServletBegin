...
<body>
	...
	<c:if test="${empty nameArr1}">
		<div>
			<span style="color: red;">nameArr1에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
	...
	<c:if test="${empty personList}">
		<div>
			<span style="color: red;">personList에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
	...
	<c:if test="${empty nameArr2}">
		<div>
			<span style="color: red;">nameArr2에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
	...
	<c:if test="${empty personList2}">
		<div>
			<span style="color: red;">personList2에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
	...
	<c:if test="${empty nameArr3}">
		<div>
			<span style="color: blue;">nameArr3에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
	...
	<c:if test="${empty personList3}">
		<div>
			<span style="color: blue;">personList3에는 데이터가 존재하지 않습니다.</span>
		</div>
	</c:if>
